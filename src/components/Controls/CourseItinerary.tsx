...
import { X, Clock, MapPin, Utensils, Coffee, Activity, Landmark, ShoppingBag } from 'lucide-react';
...
export const CourseItinerary: React.FC<CourseItineraryProps> = ({ steps, onClose }) => {
  if (steps.length === 0) {
    return (
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
        <h2 className="text-lg font-semibold">Course Itinerary</h2>
        {onClose && (
          <button
            onClick={onClose}
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`relative z-10 flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-white shadow-lg ${
                    isStart
                      ? 'bg-green-500'
                      : isEnd
                      ? 'bg-purple-500'
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {step.travelTime && step.travelTime > 0 && (
                      <span className="text-xs text-gray-400 ml-2">
                        Travel: {formatDuration(step.travelTime)}
                      </span>
                    )}
                  </div>
                  ...
                  <p className="text-sm text-gray-600 mb-2">{step.place.nameKo}</p>
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
                    ...
                    {step.place.themes && step.place.themes.length > 0 && (
                      <span className="text-gray-400">
                        {step.place.themes.join(', ')}
                      </span>
                    )}
                  </div>
